...
<head>
  ...
  <meta name="description" content="Amit Traders deals with manufacturing and supplying of leather products and corporate gift articles. Our products include Laptop Bags, Passport holders and Gents Wallet.">
    ...
    <!--Navbar -->
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
            ...
            <ul class="navbar-nav ml-auto nav-flex-icons">
                <li class="nav-item">
                    <a class="nav-link waves-effect waves-light" href="https://www.facebook.com/amittradersindia">
                    <i class="fab fa-facebook"></i>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link waves-effect waves-light" href="https://www.instagram.com/amittradersindia">
