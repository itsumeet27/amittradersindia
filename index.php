    ...
    <!-- Start your project here-->  
        ...
        <!-- About us -->
            <div class="py-5 px-4 container-fluid" style="background-color: #ffba8d75">
                <h1 class="text-center h1-responsive p-3" style="font-family:'Righteous', 'sans-serif'">ABOUT US</h1>
                <div class="row py-3">
                    <div class="about-img col-md-4 px-3 py-3">
                        <img src="img/amittradersindia.jpg" style="width:100%"/>
                    </div>
                    <div class="about-content text-justify col-md-8 px-3 py-3" style="font-family:'Poppins','sans-serif';font-size:18px;line-height:1.6em">
                        <p>
